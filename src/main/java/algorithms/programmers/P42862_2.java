...
public class P42862_2 {
  ...
  public int solution(int n, int[] lost, int[] reserve) {
    ...
    remained.forEach(i -> {
          ...
          if (record[i] != 1 && record[i] != -1 && availables.remove(i - 1) == true) {
            System.out.println("지웁니다: " + i);
            record[i] = 1;
            record[i - 1] = 3;
          } else if (record[i] != 1 && record[i] != -1 && availables.remove(i + 1) == true) {
            System.out.println("지웁니다: " + i);
            record[i] = 1;
            record[i - 1] = 3;
          }
    ...
    System.out.println("사람들한테 빌려주니까 남은 옷들 목록: " + Arrays.toString(record));
    ...
    // System.out.println("앞 사람들한테 빌려주니까 남은 옷들 목록: " + Arrays.toString(record));
